...
call TriggerRegisterPlayerEventLeave(Xe,Player(2))
call TriggerRegisterPlayerEventLeave(Xe,Player(3))
call TriggerRegisterPlayerEventLeave(Xe,Player(4))
call TriggerRegisterPlayerEventLeave(Xe,Player(5))
call TriggerRegisterPlayerEventLeave(Xe,Player(6))
call TriggerRegisterPlayerEventLeave(Xe,Player(7))
call TriggerRegisterPlayerEventLeave(Xe,Player(8))
call TriggerRegisterPlayerEventLeave(Xe,Player(9))
call TriggerRegisterPlayerEventLeave(Xe,Player($A))
call TriggerRegisterPlayerEventLeave(Xe,Player($B))
